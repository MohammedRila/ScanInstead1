    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" style={{animationDelay: '2s'}}></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-cyan-300 to-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-pulse" style={{animationDelay: '4s'}}></div>
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <Badge variant="outline" className="mb-6 bg-blue-50/80 dark:bg-blue-950/50 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800 glass-effect backdrop-blur-sm shadow-lg">
              ⚡ Smart QR Technology
            </Badge>
            <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight mb-8 leading-tight floating-animation">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Button asChild size="lg" className="text-lg px-10 py-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 pulse-glow">
                <Link href="/create">
                  Create Your QR Code
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="text-lg px-10 py-6 border-2 hover:bg-gray-50 dark:hover:bg-gray-800 glass-effect backdrop-blur-sm hover:border-blue-300 dark:hover:border-blue-600 transition-all duration-300 transform hover:scale-105">
      ...
      <section id="demo" className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-gray-50/80 to-gray-100/80 dark:from-gray-800/80 dark:to-gray-900/80 rounded-3xl p-8 md:p-12 shadow-2xl glass-effect backdrop-blur-lg border border-white/20">
            {/* Video Demo Section */}
            <div className="mb-8">
              <div className="bg-white/80 dark:bg-gray-800/80 rounded-2xl p-6 shadow-lg max-w-2xl mx-auto glass-effect backdrop-blur-sm border border-white/30 dark:border-gray-700/30">
                <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Watch ScanInstead in Action</h3>
                <div className="relative aspect-video bg-black rounded-xl overflow-hidden shadow-xl border-2 border-gradient-to-r from-blue-400 to-purple-500">
                  <video 
